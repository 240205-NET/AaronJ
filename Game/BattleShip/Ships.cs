...
namespace BattleShip
{
    class Ships
    {
        ...
        public List<Node> Carrier { get; set; }//5
        public List<Node> Battleship { get; set; }//4
        public List<Node> Destroyer { get; set; }//3
        public List<Node> Submarine { get; set; }//3
        public List<Node> PatrolBoat { get; set; }//2
        public List<Node> AllShipsPosition { get; set; } = new List<Node>();
        public List<Node> FirePositions { get; set; } = new List<Node>();
        ...
        public Ships CheckShipStatus(List<Node> HitPositions)
        {
        ...
        public List<Node> GeneratePosistion(int size, List<Node> AllPosition)
        {
        ...
        public List<Node> GeneratePositionRandomly(int size)
        {
            List<Node> positions = new List<Node>();
